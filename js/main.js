...
function getFetchHere(){
  ...
  const key = `cf6a89084f6949538a703549252702` 
      ...
      .then(data => {
        ...
        //Setting the icon
         if(data.current.condition.text == 'Partly cloudy'){
          document.querySelector('.hereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/partlyCloudy.png?raw=true`;
        } else if(data.current.condition.text == 'Sunny' || data.current.condition.text == 'Clear'){
          document.querySelector('.hereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/sun.png?raw=true`;
        } else if(data.current.condition.text == 'Overcast'){
          document.querySelector('.hereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/clouds.png?raw=true`;
        } else if(data.current.condition.text == 'Patchy light rain with thunder' || data.current.condition.text == 'Light rain' || data.current.condition.text == 'Moderate or heavy rain with thunder' || data.current.condition.text == 'Patchy rain nearby' ){
          document.querySelector('.hereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/rain.png?raw=true`;
        }
        /*if(data.current.condition.text == 'Partly cloudy'){
...
function getFetchThere(){
  ...
  fetch(url)
      ...
      .then(data => {
        ...
        //Setting the icon
        if(data.current.condition.text == 'Partly cloudy'){
          document.querySelector('.thereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/partlyCloudy.png?raw=true`;
          ...
          document.querySelector('.thereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/sun.png?raw=true`;
          document.querySelector('.menLink').href = `https://www.amazon.com/s?k=mens+light+clothing&rh=p_90%3A8308921011&dc&crid=E8LG34WIA1EB&qid=1714863925&rnid=8308919011&sprefix=mens+light+clothin%2Caps%2C143&ref=sr_nr_p_90_2&ds=v1%3A3J9mEzAydW9SlHuLmtsiGT9p7AAJEVEjbhCzXRPdIS8`
          document.querySelector('.womenLink').href = `https://www.amazon.com/s?k=womens+light+clothing&rh=p_90%3A8308921011&dc&crid=1F9V495CRACQF&qid=1715885631&rnid=8308919011&sprefix=womens+light+clothing%2Caps%2C153&ref=sr_nr_p_90_2&ds=v1%3AObSUB3HiUO%2BPzJuTSD1OW1ky0mFBp%2BeebMXL2IsI6qE`
          document.querySelector('.childrenLink').href = `https://www.amazon.com/s?k=children+light+clothing&rh=p_90%3A8308921011&dc&crid=YCU4K3I0RGPA&qid=1715885731&rnid=8308919011&sprefix=children+light+clothing%2Caps%2C126&ref=sr_nr_p_90_2&ds=v1%3AVMBkX0u50hLpj9gMKPnZ8YMsFVlPJPNbhO5ankzbBiU`
        } else if(data.current.condition.text == 'Overcast'){
          document.querySelector('.thereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/clouds.png?raw=true`;
          document.querySelector('.menLink').href = `https://www.amazon.com/s?k=mens+light+clothing&rh=p_90%3A8308921011&dc&crid=E8LG34WIA1EB&qid=1714863925&rnid=8308919011&sprefix=mens+light+clothin%2Caps%2C143&ref=sr_nr_p_90_2&ds=v1%3A3J9mEzAydW9SlHuLmtsiGT9p7AAJEVEjbhCzXRPdIS8`
          document.querySelector('.womenLink').href = `https://www.amazon.com/s?k=womens+light+clothing&rh=p_90%3A8308921011&dc&crid=1F9V495CRACQF&qid=1715885631&rnid=8308919011&sprefix=womens+light+clothing%2Caps%2C153&ref=sr_nr_p_90_2&ds=v1%3AObSUB3HiUO%2BPzJuTSD1OW1ky0mFBp%2BeebMXL2IsI6qE`
          document.querySelector('.childrenLink').href = `https://www.amazon.com/s?k=children+light+clothing&rh=p_90%3A8308921011&dc&crid=YCU4K3I0RGPA&qid=1715885731&rnid=8308919011&sprefix=children+light+clothing%2Caps%2C126&ref=sr_nr_p_90_2&ds=v1%3AVMBkX0u50hLpj9gMKPnZ8YMsFVlPJPNbhO5ankzbBiU`
        } else if(data.current.condition.text == 'Patchy light rain with thunder' || data.current.condition.text == 'Light rain' || data.current.condition.text == 'Moderate or heavy rain with thunder' || data.current.condition.text == 'Patchy rain nearby'){
          document.querySelector('.thereIcon').src = `https://github.com/DenyusKeys/hereToThere/blob/main/js/icons/rain.png?raw=true`;
